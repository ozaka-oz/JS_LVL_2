...
const renderGoodsItem = (title, price, img = 'default_picture.jpg') => `<div class="goods-item"><img src="${img}" alt="${title}"><h3>${title}</h3><p class="price">${price} руб.</p><div class="btn_basket">В корзину</div></div>`;
